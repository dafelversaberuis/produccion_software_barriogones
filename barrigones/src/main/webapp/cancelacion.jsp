					...
					<tr>
						<td style="vertical-align: top"><div class="col-xs-12">
								<div class="project-page-header">
									<h1 class="project-title"><%if(idioma==null || (idioma!=null && idioma.equals("ES"))){ %>Oppps...<%}else{ %>
Oppps...<%} %></h1>
									<h1 class="project-title">
										<%if(idioma==null || (idioma!=null && idioma.equals("ES"))){ %>Cancelaste o abandonaste la transacción <%}else{ %>

YOU HAVE CANCELLED OR ABANDONED THE TRANSACTION<%} %><b><span
											style="color: #FF0000; font-size: 100px"> :´(<br />
										</span></b>
									</h1>
								...
								<p class="input-block">
									<a class="button turquoise submit"
										...
										style="width: 300px; height: 120px; font-size: 20px; vertical-align: bottom;"><%if(idioma==null || (idioma!=null && idioma.equals("ES"))){ %>Tranquilo,
										puedes ir a tu cuenta y si quieres intentarlo nuevamente (CLIC AQUÍ)<%}else{ %>
Calm,
you can go to your account and if you want to try again ( CLICK HERE)<%} %></i>
									</a>
								</p>
							</div></td>
